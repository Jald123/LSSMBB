...
const HangarHome = () => {
    ...
    const InfoModal = ({ title, subtitle, onClose, children, action }: any) => (
        <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
    ...
    return (
        <div className="min-h-screen bg-nexus-navy text-nexus-text-primary selection:bg-nexus-cyan/30">
            <motion.div
                variants={containerVariants}
                initial="hidden"
                animate="visible"
                className="pt-32 pb-24 px-10 max-w-[1440px] mx-auto relative"
            >
                {/* 🚀 HERO SECTION */}
                ...
                <div className="grid grid-cols-12 gap-8 mb-16 px-4">
                    ...
                    <div className="col-span-12 lg:col-span-4 flex flex-col gap-6">
                        ...
                        <motion.div
                            ...
                            onClick={() => { setMethodology('DMAIC'); router.push('/journey/define'); }}
                        ...
                        <motion.div
                            variants={itemVariants}
                            whileHover={{ scale: 1.02, x: 10 }}
                            onClick={() => { setMethodology('DMADV'); router.push('/journey/define'); }}
                        ...
                        <motion.div
                            variants={itemVariants}
                            whileHover={{ scale: 1.02, x: 10 }}
                            onClick={() => { setMethodology('KAIZEN'); router.push('/journey/kickoff'); }}
                        ...
                        <motion.div
                            variants={itemVariants}
                            whileHover={{ scale: 1.02, x: 10 }}
                            onClick={() => { setMethodology('FOCUS'); router.push('/journey/find'); }}
                ...
                <AnimatePresence>
                    {activeModal === 'fundamentals' && (
                        <InfoModal
                            ...
                            action={
                                <button
                                    onClick={() => router.push('/workspace/fundamentals')}
