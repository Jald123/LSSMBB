...
const GameRenderer = ({ type, round, setRound, setScore, setIsComplete, setHoverText }: any) => {
    switch (type) {
...
const CharterGame = ({ round, setRound, setScore, setIsComplete, setHoverText }: any) => {
    const rawRounds = [
        { 
...
const SortingItem = ({ item, setHoverText }: any) => {
    return (
        <motion.div
            draggable
            onDragStart={(e: any) => {
...
const SipocGame = ({ round, setRound, setScore, setIsComplete, setHoverText }: any) => {
    const scenarios = [
...
const DraggableItem = ({ name, onMouseEnter, onMouseLeave }: any) => {
    return (
        <div
            draggable
            onDragStart={(e) => {
...
const Bucket = ({ label, content, onDrop }: any) => {
    return (
        <div
            onDragOver={(e) => {
                e.preventDefault();
...
const MsaGame = ({ round, setRound, setScore, setIsComplete, setHoverText }: any) => {
    const scenarios = [
...
const CapabilityGame = ({ round, setRound, setScore, setIsComplete, setHoverText }: any) => {
    const scenarios = [
