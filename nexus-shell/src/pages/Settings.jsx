...
const Settings = () => {
    ...
    return (
        ...
        >
            <div className="mb-8">
                <h1 className="text-4xl font-black font-orbitron text-nexus-text-primary mb-2">SYSTEM SETTINGS</h1>
                <p className="text-nexus-text-secondary">Configure your Nexus OS environment.</p>
            </div>
            ...
            <motion.div variants={itemVariants} className="mb-8">
                ...
                <div className="bg-nexus-card border border-nexus-border rounded-2xl overflow-hidden backdrop-blur-md">
                    <div className="p-6 flex items-center justify-between border-b border-nexus-border">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-nexus-text-primary font-bold">Interface Theme</h3>
                                <p className="text-xs text-nexus-text-secondary">Toggle between dark command mode and light day mode.</p>
                            </div>
                        </div>
                        <button
                            onClick={toggleTheme}
            ...
            {/* 🔔 NOTIFICATIONS (Stub) */}
            <motion.div variants={itemVariants} className="mb-8">
                <h2 className="text-sm font-bold text-nexus-text-secondary mb-4 uppercase tracking-widest flex items-center gap-2">
                ...
                <div className="bg-nexus-surface/20 border border-nexus-border/50 rounded-2xl p-6 flex flex-col gap-4 opacity-75">
                    <div className="flex items-center justify-between">
                        <span className="text-nexus-text-secondary text-sm font-medium">Mission Critical Alerts</span>
                    ...
                    <div className="flex items-center justify-between">
                        <span className="text-nexus-text-secondary text-sm font-medium">XP Gains & Achievements</span>
                        <div className="w-10 h-5 bg-nexus-success/20 rounded-full relative cursor-not-allowed">
                            <div className="absolute right-1 top-1 w-3 h-3 bg-nexus-success rounded-full" />
                        </div>
                    </div>
            ...
            <motion.div variants={itemVariants}>
                ...
                <div className="bg-nexus-surface/20 border border-nexus-border/50 rounded-2xl p-6 flex items-center gap-4">
                    <Lock className="w-8 h-8 text-nexus-text-secondary" />
                    <div>
                        <h3 className="text-nexus-text-primary font-bold">Clearance Level: UNCLASSIFIED</h3>
                        <p className="text-xs text-nexus-text-secondary">Local storage persistence only. No cloud sync active.</p>
                    </div>
                </div>
            </motion.div>
