...
function _buildCommandHub() {
    ...
    const existing = document.getElementById('sensei-mbb-rail');
    ...
    hub.innerHTML = `
        <!-- Header / Drag Handle / Robot (Always Visible) -->
        ...
        <div class="rail-expanded-content" style="display: contents;">
            ...
            <div class="rail-footer-pills" style="display: flex; flex-direction: row; gap: 8px;">
                <div class="rail-pill active" onclick="lssSetTheme('twilight')" title="Balanced Day">
                    <i class="fas fa-sun"></i>
                </div>
                <div class="rail-pill" onclick="lssSetTheme('night')" title="Futuristic Night">
    ...
    // Hide standard submit button for clean workspace
    const oldBtn = document.getElementById('lss-submit-btn');
    if (oldBtn) oldBtn.style.display = 'none';
}

// Pointer-based Drag Engine (replaces legacy mouse-only _initDraggable)
